...
export class QuotesDisplayComponent implements OnInit {
  ...
  quotes: Quote[] = [
    new Quote(1, 'Life isn\'t about getting and having, it\'s about giving and being.', 'Kevin Kruse', 'Kevin Kruse', 0, 0),
    new Quote(2, 'Whatever the mind of man can conceive and believe, it can achieve.', 'Napoleon Hill', 'Napoleon Hill', 0, 0),
